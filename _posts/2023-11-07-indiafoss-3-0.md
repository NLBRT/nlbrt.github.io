...
![The NIMHANS Convention Center, lit in the evening, as seen from the entrance](insertimagevro)
...
![A Rava Dosa served on a metal plate with compartments, with dosa in one of the compartments, and sambar and coconut chutney in the other two individually](insertimagevro)
...
![A small plate with vanilla ice cream with sprinkles on top](insertimagevro)
...
![The mapping workshop](insertimagevro)

![The folks during the mapping party](insertimagevro)
...
![Kailash Nadh checking out an edit on OpenStreetMap](insertimagevro)
